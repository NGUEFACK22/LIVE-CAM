...
export function EsimPromo() {
  return (
    <Link
      href="/numbers"
      aria-label="Découvrir LIVE SIM : numéros virtuels, SMS OTP et proxies premium"
    ...
    >
      ...
      <div className="relative flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-lg font-extrabold leading-none tracking-tight text-white">LIVE SIM</p>
