...
// Guide OBS Virtual Camera — chemin de diffusion PRINCIPAL (comme avant)
const obsSteps = [
  {
    id: 1,
  ...
  {
    id: 3,
    title: "Utiliser dans WhatsApp, Zoom, Teams, Meet...",
    description: "Selectionnez 'OBS Virtual Camera' dans vos apps.",
    icon: Video,
    details: [
      "Ouvrez WhatsApp, Zoom, Teams, Google Meet ou Discord",
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className={`text-xs ${activeTab === 'obs' ? 'text-white/80' : 'text-white/40'}`}>
                    Avec OBS Virtual Camera (Recommande)
                  </div>
                </div>
              </div>
            </button>
        ...
        >
          <p className={`text-center ${activeTab === 'ndi' ? 'text-[#25D366]' : 'text-[#2D8CFF]'}`}>
            {activeTab === 'ndi' 
              ...
              : "OBS Virtual Camera fonctionne partout : WhatsApp, Zoom, Teams, Google Meet, Discord, Telegram."
            }
          </p>
        </motion.div>
