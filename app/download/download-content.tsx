...
export default function DownloadContent({ windowsUrl, macUrl, macArmUrl, version }: DownloadContentProps) {
  return (
    <>
      <div className="pt-24 pb-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-[#00ff88]/50 transition-colors">
              ...
              <div className="space-y-3 mb-6">
                ...
                <a href={macArmUrl} target="_blank" rel="noopener noreferrer">
          ...
          >
            <p>Version {version} | Derniere mise a jour: Août 2026</p>
          </motion.div>
        </div>
      </div>
    </>
