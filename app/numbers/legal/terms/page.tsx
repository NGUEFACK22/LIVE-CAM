...
export const metadata: Metadata = { title: 'Terms of Service — LIVECAM Numbers' }
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      updated="June 2026"
      intro="These Terms of Service govern your access to and use of the LIVECAM Numbers platform. By creating an account, you agree to be bound by these terms."
      sections={[
        { heading: 'Acceptance of Terms', body: ['By registering for or using LIVECAM Numbers, you confirm that you have read, understood, and agree to these Terms of Service, our Privacy Policy, and our Acceptable Use Policy.', 'If you are using the service on behalf of an organization, you represent that you have authority to bind that organization to these terms.'] },
        { heading: 'Description of Service', body: ['LIVECAM Numbers provides access to virtual phone numbers aggregated from multiple telecommunication providers for the purpose of legitimate business communications, customer verification, testing, and software integrations.'] },
        ...
        { heading: 'Limitation of Liability', body: ['To the maximum extent permitted by law, LIVECAM Numbers is not liable for indirect, incidental, or consequential damages arising from your use of the service.'] },
